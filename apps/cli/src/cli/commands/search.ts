import { SearchResult } from "@mcpctl/core";
...
function loadSystemPrompt() {
  ...
  2. You can generate a mcpctl install command by step-by-step
    ...
    B. Fill the template:
      "mcpctl install --client <client:claude | cursor> --server-name <name> --command <command> [--profile <profile> --env <key1=value1> --env <key2=value2> --secret <key1=value1> --secret <key2=value2>]"
      ...
      # Examples
        mcpctl install --client claude --server-name my-mcp-server --command "npx -y @modelcontextprotocol/server-slack" --profile my-profile --secret SLACK_BOT_TOKEN=xoxb-1234567890 --env SLACK_TEAM_ID=T00000000 --env SLACK_CHANNEL_ID=C000000000 --env SLACK_CHANNEL_IDS="C000000000,C000000001"
