import { McpServerType, Profile } from "@vessl-ai/mcpctl-core/types";
import fs from "fs";
...
describe("ProfileStore", () => {
  ...
  describe("constructor", () => {
    it("should create profile directory if it does not exist", () => {
      ...
      expect(fs.mkdirSync).toHaveBeenCalledWith(testProfileDir, {
        recursive: true,
      });
  ...
  describe("loadProfile", () => {
    ...
    it("should throw error if profile file is malformed", () => {
      ...
      expect(() => profileStore.loadProfile("test-profile")).toThrow(
        SyntaxError
      );
    });
  });
  ...
  describe("deleteProfile", () => {
    ...
    it("should handle delete errors", () => {
      ...
      expect(() => profileStore.deleteProfile("test-profile")).toThrow(
        "Delete error"
      );
    });
  });
