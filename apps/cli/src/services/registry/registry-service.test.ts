...
describe("RegistryService", () => {
  ...
  beforeEach(() => {
    ...
    registryProviderFactory.createOrGetRegistryProvider.mockReturnValue(
  ...
  describe("getRegistryDef", () => {
    it("should return registry definition from store", () => {
      ...
      expect(registryDefStore.getRegistryDef).toHaveBeenCalledWith(
        "test-registry"
      );
  ...
  describe("getRegistryProvider", () => {
    it("should return provider for registry", () => {
      ...
      expect(
        registryProviderFactory.createOrGetRegistryProvider
      ).toHaveBeenCalledWith(mockRegistryDef);
    ...
    it("should throw error if registry not found", () => {
      ...
      expect(() => registryService.getRegistryProvider("non-existent")).toThrow(
        "Registry not found"
      );
    });
  });
  ...
  describe("deleteRegistryDef", () => {
    it("should delete registry definition from store", () => {
      ...
      expect(registryDefStore.deleteRegistryDef).toHaveBeenCalledWith(
        "test-registry"
      );
    });
  });
