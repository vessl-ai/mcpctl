...
export class McpClientServiceImpl implements McpClientService {
  ...
  async installMcpServerToClient(client: McpClient, serverInstallConfig: McpServerInstallConfig): Promise<void> {
    switch (client.type) {
  ...
  private async installMcpServerToClaude(client: McpClient, serverInstallConfig: McpServerInstallConfig): Promise<void> {
  ...
  private async installMcpServerToCursor(client: McpClient, serverInstallConfig: McpServerInstallConfig): Promise<void> {
  ...
  private generateCommand(serverInstallConfig: McpServerInstallConfig): [string, string[]] {
