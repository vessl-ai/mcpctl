...
describe('FileConfigStore', () => {
  ...
  describe('saveConfig', () => {
    it('should write config to file', () => {
      ...
      expect(fs.writeFileSync).toHaveBeenCalledWith(testConfigPath, JSON.stringify(mockConfig, null, 2));
      expect(logger.verbose).toHaveBeenCalledWith(
        `Saving config to ${testConfigPath}, ${JSON.stringify(mockConfig, null, 2)}`
      );
